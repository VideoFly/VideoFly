...
/**
 * Created by madhavchhura on 5/27/15.
 */
...
public class CircleVideoRenderer extends BaseVideoRenderer {
    ...
    static class MyRenderer implements GLSurfaceView.Renderer {
        ...
        private final String fragmentShaderCode = "precision mediump float;\n"
                ...
                + "  highp float distanceFromCenter = distance(center, vTextureCoord);\n"
                + "  lowp float pointInCircle = step(distanceFromCenter, radius);\n"
                + "  gl_FragColor=vec4(r,g,b,1.0) * pointInCircle;\n"
                + "}\n";
        ...
        void setupTextures(Frame frame) {
            ...
            initializeTexture(GLES20.GL_TEXTURE1, mTextureIds[1], w / 2, h / 2);
            initializeTexture(GLES20.GL_TEXTURE2, mTextureIds[2], w / 2, h / 2);
        ...
        void updateTextures(Frame frame) {
            ...
            int quarterPlaneSize = planeSize >> 2;
            ...
            if (bb.remaining() == planeSize + quarterPlaneSize * 2) {
                ...
                GLES20.glTexSubImage2D(GLES20.GL_TEXTURE_2D, 0, 0, 0,
                        width / 2, height / 2, GLES20.GL_LUMINANCE,
...
//                        scaleY, 1);
                ...
                Matrix.scaleM(mScaleMatrix, 0, (mCurrentFrame.isMirroredX() ? -1.0f : 1.0f), 1, 1);

                // FIXME This code looks like the cause of the "skipped xx frames!" warning
    ...
    public CircleVideoRenderer(Context context) {
